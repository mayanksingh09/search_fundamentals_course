...
def index_file(file, index_name):
    ...
    for child in children:
        ...
        # the_doc = bulk(client=client, index=index_name, chunk_size=2000, actions=[{'_id': doc['productId'][0], '_source': doc}])
        the_doc = bulk(client=client, index=index_name, chunk_size=2000, actions=[{'_id': doc["sku"][0], '_source': doc, '_index': index_name}])
        docs.append(the_doc)
